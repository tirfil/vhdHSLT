...
ghdl -a --work=WORK --workdir=ALL_LIB $FLAG ../TEST/tb_bitclock.vhd
ghdl -e --work=WORK --workdir=ALL_LIB tb_bitclock
ghdl -r --work=WORK --workdir=ALL_LIB tb_bitclock --vcd=tb_bitclock.vcd
