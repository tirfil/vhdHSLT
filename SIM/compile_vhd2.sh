...
ghdl -a --work=WORK --workdir=ALL_LIB $FLAG ../VHDL/div4.vhd
...
ghdl -a --work=WORK --workdir=ALL_LIB $FLAG ../TEST/tb_testchipx2.vhd
ghdl -e --work=WORK --workdir=ALL_LIB tb_testchip
ghdl -r --work=WORK --workdir=ALL_LIB tb_testchip --vcd=testchipx2.vcd
